                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="contact-widget">
                        ...
                        <div class="cw-item">
                            <h5>Phone</h5>
                            <ul>
                                <a href="tel:+1 (603)535-4592"><li>+1 (603)535-4592</li></a>
                                <a href="tel:+1 (603)535-4592"><li>+1 (603)535-4556</li></a>
                            </ul>
                        </div>
                        <div class="cw-item">
                            <h5>E-mail</h5>
                            <ul>
                                <a href="mailto:contact@violetstore.com"><li>contact@violetstore.com</li></a>
                                <a href="mailto:contact@violetstore.com"><li>www.violetstore.com</li></a>
                            </ul>
                        </div>
                    </div>
                </div>
