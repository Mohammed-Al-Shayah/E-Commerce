                                    ...
                                    <div class="card">
                                        <div class="card-body p-0">
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-1">
                                                        <p class="mt-3 text-muted fw-bold font-size-14 mb-0">Since last
                                                            month
                                                        </p>
                                                    </div>
                                                    <div class="">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="p-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="">
                                                        <p
                                                            class="badge bg-soft-primary text-primary fw-bold font-size-12">
                                                            Yearly</p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:68px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:45px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:55px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:70px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:48px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:35px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-primary rounded"
                                                                role="progressbar" style="width: 6px; height:54px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-success rounded"
                                                                role="progressbar" style="width: 6px; height:28px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                                        ...
                                                        <div class="progress progressbar-vertical-graph">
                                                            <div class="progress-bar bg-success rounded"
                                                                role="progressbar" style="width: 6px; height:31px;"
                                                                aria-valuenow="25" aria-valuemin="0"
                                                                aria-valuemax="100"></div>
                                                        </div>
                                                        <div class="progress progressbar-vertical-graph">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="d-flex">
                                                <div class="">
                                                    <i
                                                        class="mdi mdi-circle-double font-size-13 me-2 text-primary"></i>
                                                </div>
                                                <div>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex">
                                                <div class="">
                                                    <i
                                                        class="mdi mdi-circle-double font-size-13 me-2 text-success"></i>
                                                </div>
                                                <div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="me-3">
                                                                <img src="{{ asset('adminassets/assets/images/users/avatar-1.jpg') }}"
                                                                    class="avatar-xs h-auto rounded-circle"
                                                                    alt="Error">
                                                            </div>
                                                            <div>
                                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                                        href="#" class="text-dark">Julia Fox</a>
                                                                </h5>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="me-3">
                                                                <img src="{{ asset('adminassets/assets/images/users/avatar-2.jpg') }}"
                                                                    class="avatar-xs h-auto rounded-circle"
                                                                    alt="Error">
                                                            </div>
                                                            <div>
                                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                                        href="#" class="text-dark">Max Jazz</a>
                                                                </h5>
                                                                <p class="text-muted mb-0 font-size-11 text-uppercase">
                                                                    Vatican City</p>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="me-3">
                                                                <img src="{{ asset('adminassets/assets/images/users/avatar-5.jpg') }}"
                                                                    class="avatar-xs h-auto rounded-circle"
                                                                    alt="Error">
                                                            </div>
                                                            <div>
                                                                <h5 class="font-size-13 text-truncate mb-1"><a
                                                                        href="#" class="text-dark">Julia
                                                                        Fox</a>
                                                                </h5>
                                                                <p class="text-muted mb-0 font-size-11 text-uppercase">
                                                                    Glory
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded bg-light">
                                                                <img src="{{ asset('adminassets/assets/images/product/img-11.png') }}"
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            ...
                                                            <a href=""
                                                                class="text-primary fw-bold font-size-11">ID
                                                                :
                                                                #NC1097</a>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded bg-light">
                                                                <img src="{{ asset('adminassets/assets/images/product/img-9.png') }}"
                                                                    class="avatar-sm" alt="Error">
                                                            </span>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded bg-light">
                                                                <img src="{{ asset('adminassets/assets/images/product/img-1.png') }}"
                                                                    class="avatar-sm" alt="Error">
                                                            </span>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded bg-light">
                                                                <img src="{{ asset('adminassets/assets/images/product/img-4.png') }}"
                                                                    class="avatar-sm" alt="Error">
                                                            </span>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-sm">
                                                            <span class="avatar-title rounded bg-light">
                                                                <img src="{{ asset('adminassets/assets/images/product/img-3.png') }}"
                                                                    class="avatar-sm" alt="Error">
                                                            </span>
                                                        </div>
                                                    </td>
