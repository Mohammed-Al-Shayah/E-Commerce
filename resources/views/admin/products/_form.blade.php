...
<div class="mb-3">
    ...
    <textarea name="content_en" placeholder="English Content" class="myeditor">{{ $product->en_content }}</textarea>
</div>

<div class="mb-3">
    <label>Arabic Content</label>
    <textarea name="content_ar" placeholder="Arabic Content" class="myeditor">{{ $product->ar_content }}</textarea>
</div>
